...
public class AliyunOSSClientUtil {
    ...
    public void init() {
        ...
        aliyunOSSClientUtil.zdMapper = this.zdMapper;
        aliyunOSSClientUtil.zdxMapper = this.zdxMapper;
    }
    //字典名称
    public static final String ZDMC = "alioss";
    //log日志
...
//		FOLDER = OSSClientConstants.FOLDER;
    ...
    public OSSClient getOSSClient() {
        String id = aliyunOSSClientUtil.zdMapper.selectIdByName(ZDMC);
        Zdx aliKey = aliyunOSSClientUtil.zdxMapper.selectOne(Wrappers.<Zdx>lambdaQuery()
                .eq(Zdx::getZdid, id)
                .eq(Zdx::getName, CommonConstants.aliKey)
                .eq(Zdx::getDelFlag, CommonConstants.DELETE_FLAG));
        ACCESS_KEY_ID = aliKey.getValue();

        Zdx aliSecret = aliyunOSSClientUtil.zdxMapper.selectOne(Wrappers.<Zdx>lambdaQuery()
                .eq(Zdx::getZdid, id)
                .eq(Zdx::getName, CommonConstants.aliSecret)
                .eq(Zdx::getDelFlag, CommonConstants.DELETE_FLAG));
        ACCESS_KEY_SECRET = aliSecret.getValue();
